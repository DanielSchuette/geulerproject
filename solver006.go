...
// SumOfSquares squares all natural numbers up to n, adds
...
// SquareOfSums calculates the sum of all natural numbers up
// to n, squares it, and returns it.
...
// FastSumOfSquares implements the alternative solution for
// deriving the sum of squared natural numbers up to n.
...
// FastSquareOfSums implements the alternative solution for
// deriving the sum of squared natural numbers up to n.
